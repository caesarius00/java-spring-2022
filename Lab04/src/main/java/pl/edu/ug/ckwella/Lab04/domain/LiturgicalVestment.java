...
public class LiturgicalVestment {
    ...
    public LiturgicalVestment(String ID, String name, String primaryColor, String secondaryColor, String material, String liningMaterial, String cutType, String size, String description) {
        this.id = ID;
        this.name = name;
